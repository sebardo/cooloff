...
<div id="dialog-mailing" title="<?php echo __('Seleccione inscripciones que recibirán email de confirmación') ?>" style="display: none; z-index: 10000; font-size: 12px; max-height: 400px">
	<p><?php echo __('loading_wait') ?></p>
</div>
...
<script type="text/javascript">
	...
	var loadingWait = "<?php echo __('loading_wait') ?>";
	var sendingWait = "<?php echo __('sending_wait') ?>";
	var sentOk = "<?php echo __('envíos realizados correctamente') ?>";
</script>